...
def rpn(base_layers, num_anchors):
    ...
    x = Conv2D(256, 3, 3, border_mode='same', activation='relu', init="he_normal", name='rpn_conv1')(base_layers)

    x_class = Conv2D(num_anchors, 1, 1, activation='sigmoid', init="uniform", name='rpn_out_class')(x)
    x_regr = Conv2D(num_anchors * 4, 1, 1, activation='linear', init="zero", name='rpn_out_regress')(x)
